...
public class ConfigurationOrdinaryRuleTest
{
    [Fact]
    public void ApplyRuleWhenAddedToAppSettingsSuccess()
    {
        ...
        builder.Configuration.AddCustomConfigurationRule<CustomJsonConfigurationSource, TestOrdinaryRule>();
    ...
    public void ApplyRuleWhenAddedCustomSourceSuccess()
    {
        ...
        source.AddCustomConfigurationRule<TestOrdinaryRule>();
